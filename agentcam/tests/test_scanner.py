...
class TestScannerInterface:
    def test_no_unimplemented_custom_rules_parameter(self):
        assert "ruleset" not in inspect.signature(scan_paths).parameters
        assert "ruleset" not in inspect.signature(scan_output).parameters
